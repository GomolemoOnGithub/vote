...
document.getElementById('ticket_code').addEventListener('input', function (e) {
...
{
swal("Ticket Code?", "You entered an invalid ticket number, try again",'info');
}
...
swal(
'Well done!',
'We appreciate you being part of this journey to uncover our 2018 queen.',
'success'
);
}
else
...
swal("Ticket already used", "One ticket, one vote",'info');
}
